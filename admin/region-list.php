...
$tct = Region::count( array( 'parent' => $parent ) ); 	//total count
$rpp = 10; 												//row per page
...
$regions = Region::get_all( array( 'r.parent' => $parent ), '', ( $from - 1 ) . ", $rpp" );
		...
		<table class="table">
			...
			<tbody>	
				...
				<tr>
					...
					?>	
					<td>
						<a href=<?php print 'region-edit.php?' . build_query_string( array( 'id' => $row['id'] ) ); ?>>Edit</a>		
