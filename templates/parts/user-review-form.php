<div class="form-panel">
	...
	<fieldset>
		...
		<legend>Rate this User</legend>	
		
		<form name="form_rate_user" id="form_rate_user" method="post" enctype='application/x-www-form-urlencoded' accept-charset="utf-8">
			...
			<div class="fleft">												
				<div class="input-block">												
					<a href='user-view.php?id=<?=$user['id']?>'>Cancel</a>			
				</div>
			</div>
